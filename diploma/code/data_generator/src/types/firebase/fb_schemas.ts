...
export const fBNoteSchema = z.object({
  createdAt: timestampSchema,
  content: z.string(),
}).strict()

export const fBGoalSchema = z.object({
  title: z.string(),
...
export const fBMedicationSchema = firebaseDocIdSchema.extend({
  imageUrl: z.string(),
  title: z.string(),
  description: z.string(),
...
export const fBTakenMedicationSchema = z.object({
  medication: fBMedicationSchema,
  time: timestampSchema,
  dosage: z.number(),
}).strict()

export const fBMessageSchema = z.object({
  createdAt: timestampSchema,
  content: z.string(),
  sender: fbUserIdSchema,
}).strict()

export const fBEmployeeReviewSchema = z.object({
  createdAt: timestampSchema,
...
export const fBDialogSchema = firebaseDocIdSchema.extend({
  doctor: fbUserIdSchema,
  patient: fbUserIdSchema,
  messages: z.array(fBMessageSchema),
}).strict()

export const fBDailyLogSchema = z.object({
  createdAt: timestampSchema,
...
export const fBThematicMaterialSchema = firebaseDocIdSchema.extend({
  imageUrl: z.string(),
  docUrl: z.string(),
  createdAt: timestampSchema,
  title: z.string(),
...
export const fBDiarySchema = z.object({
  dailyLogs: z.array(fBDailyLogSchema),
  goals: z.array(fBGoalSchema),
}).strict()

export const fBUserSchema = firebaseDocIdSchema.extend({
